...
if __name__ == "__main__":
    ...
    game_urls = [
        f"https://www.giantbomb.com/api/search/?api_key={gb_key}&query={game}&field_list=name,id&format=json"
    ...
    pub_urls = [
        f"https://www.giantbomb.com/api/game/{_id}/?api_key={gb_key}&field_list=name,publishers&format=json"
        for _id in game_ids
    ]
